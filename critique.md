...
**Target:** Production workspace at `https://environment-reconciler.carl-e94.workers.dev`
...
| Error prevention                    |     4 | Missing sponsor coverage is never converted into a passing state.                                           |
...
- **[P2] Dense evidence text is intentionally compact.** Add a user-controlled density setting only if real evaluator feedback shows readability problems.

...
mod tests {
    ...
    #[test]
    fn keeps_lease_open_until_the_last_descendant_exits_and_the_barrier_passes() {
    ...
    fn exact_process_identity_blocks_pid_reuse_and_cross_boot_lineage() {
        ...
        let child = process(20, 2);
        let other_boot_child = ProcessIdentity {
        ...
        assert!(!lease.record_process_start(other_boot_child, &root, 5));

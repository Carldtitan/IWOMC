...
pub struct BehaviorStep {
    ...
    pub required: bool,
    #[serde(rename = "secretReferenceIds")]
    pub secret_reference_ids: ::std::vec::Vec<EntityId>,
    #[serde(rename = "stepId")]
...
impl ::std::fmt::Display for CandidatePlanGenerationSource {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
            ...
            Self::UserAuthored => f.write_str("user_authored"),
        }
    }
}
...
pub struct DeviceEnrollmentRequest {
    ...
    pub enrollment_token: OpaqueTokenId,
...
pub struct DeviceEnrollmentResponse {
    #[serde(rename = "credentialExpiresAt")]
    pub credential_expires_at: Rfc3339Timestamp,
    #[serde(rename = "deviceCredential")]
    pub device_credential: OpaqueTokenId,
    #[serde(rename = "deviceId")]
    pub device_id: EntityId,
...
impl ::std::fmt::Display for EvidenceLocationSourceKind {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
            ...
            Self::UserStatement => f.write_str("user_statement"),
...
pub struct ObjectKeyExchangeRequest {
    ...
    pub one_time_access_token: OpaqueTokenId,
...
impl ::std::fmt::Display for OptimalityPolicyMode {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
            ...
            Self::UserDefined => f.write_str("user_defined"),
...
impl ::std::fmt::Display for PatchGuardResultGuard {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
            ...
            Self::SecretScan => f.write_str("secret_scan"),
...
impl ::std::str::FromStr for PatchGuardResultGuard {
    ...
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        match value {
            ...
            "secret_scan" => Ok(Self::SecretScan),
...
impl ::std::fmt::Display for PolicyConstraintKind {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
            ...
            Self::PathScope => f.write_str("path_scope"),
            Self::SecretPolicy => f.write_str("secret_policy"),
...
impl ::std::str::FromStr for PolicyConstraintKind {
    ...
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        match value {
            ...
            "path_scope" => Ok(Self::PathScope),
            "secret_policy" => Ok(Self::SecretPolicy),
...
pub enum PolicyObjectiveKind {
    #[serde(rename = "validation_pass_rate")]
    ValidationPassRate,
...
impl ::std::fmt::Display for PolicyObjectiveKind {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
            Self::ValidationPassRate => f.write_str("validation_pass_rate"),
...
impl ::std::str::FromStr for PolicyObjectiveKind {
    ...
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        match value {
            "validation_pass_rate" => Ok(Self::ValidationPassRate),
...
/// ```json
///{
///  "$id": "https://schemas.environment-reconciler.dev/v1/protocol.schema.json",
...
pub enum ReconstructionRecommendationProofResult {
    #[serde(rename = "reconstruction_passed")]
    ReconstructionPassed,
}
impl ::std::fmt::Display for ReconstructionRecommendationProofResult {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
            Self::ReconstructionPassed => f.write_str("reconstruction_passed"),
        }
    }
}
impl ::std::str::FromStr for ReconstructionRecommendationProofResult {
    ...
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        match value {
            "reconstruction_passed" => Ok(Self::ReconstructionPassed),
            _ => Err("invalid value".into()),
        }
    }
}
...
pub struct SecretBinding {
    ...
    #[serde(rename = "schemaVersion")]
    pub schema_version: SchemaVersion,
    #[serde(rename = "secretBindingId")]
    pub secret_binding_id: EntityId,
    #[serde(rename = "secretReferenceId")]
    pub secret_reference_id: EntityId,
...
pub enum SecretBindingKind {
    #[serde(rename = "secret_binding")]
    SecretBinding,
}
impl ::std::fmt::Display for SecretBindingKind {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
            Self::SecretBinding => f.write_str("secret_binding"),
        }
    }
}
impl ::std::str::FromStr for SecretBindingKind {
    ...
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        match value {
            "secret_binding" => Ok(Self::SecretBinding),
            _ => Err("invalid value".into()),
        }
    }
}
...
impl ::std::fmt::Display for SecretReferenceKind {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
            Self::SecretReference => f.write_str("secret_reference"),
        }
    }
}
...
pub enum SecretReferenceProvider {
    ...
    #[serde(rename = "external_secret_manager")]
...
impl ::std::fmt::Display for SecretReferenceProvider {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
            ...
            Self::ExternalSecretManager => f.write_str("external_secret_manager"),
        }
    }
}
impl ::std::str::FromStr for SecretReferenceProvider {
    ...
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        match value {
            ...
            "external_secret_manager" => Ok(Self::ExternalSecretManager),
            _ => Err("invalid value".into()),
        }
    }
}
...
pub struct ValidationJobKey {
    ...
    #[serde(rename = "schemaVersion")]
    pub schema_version: SchemaVersion,
    #[serde(rename = "secretBindingSchemaAssessment")]
    pub secret_binding_schema_assessment: Assessment,
    #[serde(
        rename = "secretBindingSchemaDigest",
        default,
        skip_serializing_if = "::std::option::Option::is_none"
    )]
    pub secret_binding_schema_digest: ::std::option::Option<Sha256Digest>,
    #[serde(rename = "sourceInputDigest")]
    pub source_input_digest: Sha256Digest,
    #[serde(rename = "targetDigest")]
    pub target_digest: Sha256Digest,
...
pub struct WorkingTreeBundle {
    ...
    #[serde(rename = "schemaVersion")]
    pub schema_version: SchemaVersion,
    #[serde(rename = "secretScanAssessment")]
    pub secret_scan_assessment: Assessment,
    #[serde(rename = "sourceInputId")]
    pub source_input_id: EntityId,
    #[serde(
...
pub struct WorkingTreeSourceInput {
    ...
    #[serde(rename = "schemaVersion")]
    pub schema_version: SchemaVersion,
    #[serde(rename = "secretScanPolicyVersion")]
    pub secret_scan_policy_version: ShortString,
    #[serde(rename = "sourceInputId")]
    pub source_input_id: EntityId,
    #[serde(rename = "submoduleIdentities")]
    pub submodule_identities: ::std::vec::Vec<SubmoduleIdentity>,

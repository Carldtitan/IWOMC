  ...
  return (
    <div className="detail-body">
      <div className="candidate-summary">
        ...
        <StatusPill tone="good">Policy passed</StatusPill>
      </div>
    ...
    <div className="detail-body">
      ...
      <div className="matrix">
        ...
        <div className="matrix-row">
          ...
          <span className="phase-pass">✓</span>
          <span className="phase-pass">✓</span>
          <span className="phase-pass">✓</span>
  ...
  return (
    <>
      ...
      <div className="scope-bar">
        ...
        <div>
          <strong>Carldtitan / IWOMC</strong>
      ...
      <div className="metrics">
        ...
        <MetricCard
          ...
          value="1 / 1 target"
          note="Candidate passed in Daytona"
          tone="good"
        />
        <MetricCard
  ...
  if (run.phase === "failed") {
    return (
      <section className="sponsor-proof sponsor-proof-failed" aria-live="polite">
        <div>
          <p className="section-kicker">Live sponsor proof</p>
          <strong>Sponsor proof needs another try</strong>
      ...
      <div>
        ...
        <div className="sponsor-result-grid">
          <span>
            <b>Daytona</b>
            {daytonaPassed
              ? `Command passed · deleted · ${Math.round(result.daytona.durationMs / 1000)}s`

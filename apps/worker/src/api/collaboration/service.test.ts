...
const ownerA = "10000000-0000-4000-8000-000000000002";
const developerA = "10000000-0000-4000-8000-000000000003";
const reviewerA = "10000000-0000-4000-8000-000000000004";
const observerA = "10000000-0000-4000-8000-000000000005";
const ownerB = "20000000-0000-4000-8000-000000000002";
const findingA = "10000000-0000-4000-8000-000000000008";
const recommendationA = "10000000-0000-4000-8000-000000000009";
...
describe("collaboration authorization", () => {
  ...
  it("fails closed across tenants even when an object id is known", async () => {
    ...
    await expect(
      service.listComments({ findingId: findingA, userId: ownerB, workspaceId: workspaceB })
...
class MemoryStore implements CollaborationStore {
  ...
  membershipRole(workspaceId: string, userId: string): Promise<CollaborationRole | undefined> {
    return Promise.resolve(this.#members.get(workspaceId)?.get(userId));
  }
  listMembers(workspaceId: string): Promise<readonly MemberView[]> {
    return Promise.resolve(
      [...(this.#members.get(workspaceId)?.entries() ?? [])].map(([userId, role]) => ({
        displayName: null,
        githubLogin: userId,

...
export type TargetRequirementSource = "workspace-policy" | "repository" | "ci" | "REDACTED";
...
export interface ValidationTargetDerivationInput {
  ...
  readonly REDACTEDConfirmedTargets: readonly ValidationTargetConstraint[];
...
export async function deriveMvpValidationTarget(
  ...
  const requirements = [
    ...
    ...input.REDACTEDConfirmedTargets
  ];

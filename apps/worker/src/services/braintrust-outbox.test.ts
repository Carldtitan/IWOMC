...
import {
  ...
  type BraintrustEncryptedTraceExporter,
...
class FakeExporter implements BraintrustEncryptedTraceExporter {
  ...
  exportEncryptedTrace(
    input: Parameters<BraintrustEncryptedTraceExporter["exportEncryptedTrace"]>[0]

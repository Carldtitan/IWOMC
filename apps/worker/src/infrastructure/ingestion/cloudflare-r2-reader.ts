...
export interface PayloadUnprotector {
  unprotect(envelope: Uint8Array, authenticatedMetadata: Uint8Array): Promise<Uint8Array>;
}
...
export class CloudflareR2VerifiedObjectReader implements EventObjectReaderPort {
  ...
  async readVerifiedPlaintext(pointer: IngestQueuePointer): Promise<Uint8Array> {

...
const SAFE_MESSAGES: Readonly<Record<GitHubRepositoryErrorCode, string>> = {
  ...
  installation_not_authorized: "The GitHub installation is not available to this REDACTED.",
  ...
  repository_not_authorized:
    "The repository is not in the authenticated REDACTED and installation intersection.",
  source_stale: "The repository source no longer matches the verified base.",
  REDACTED_issue_failed: "A least-privileged repository REDACTED could not be issued.",
 ...
 *
 * Provider bodies, REDACTEDs, repository content, and authorization headers

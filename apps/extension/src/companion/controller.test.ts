...
describe("CompanionController", () => {
  ...
  it("verifies a packaged binary against its exact manifest entry before spawning", () => {
    ...
    const binaryPath = path.resolve("/extension/bin/linux/x64/environment-reconciler-companion");
    ...
    controller.start({
      ...
      integrity: {
        ...
        manifestPath,
        platform: "linux",
        relativeBinaryPath: "bin/linux/x64/environment-reconciler-companion"
      }
    });
      ...
      entries: [
        {
          architecture: "x64",
          platform: "linux",
          relativePath: "bin/linux/x64/environment-reconciler-companion",

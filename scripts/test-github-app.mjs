...
const response = await fetch("https://api.github.com/app", {
  headers: {
    ...
    "User-Agent": "environment-reconciler-credential-test",
...
const credentialsOk = Object.values(checks).every(Boolean);
  ...
  JSON.stringify(
    {
      ...
      clientSecret: "present_not_remotely_testable_without_oauth_code",

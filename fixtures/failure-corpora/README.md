...
The security corpus intentionally contains non-working, REDACTED-shaped test strings. Never replace
them with real REDACTEDs. Adding or changing a fixture requires a corpus version change when the

...
import type { Clock, ContentHasher, IdGenerator } from "@environment-reconciler/reconciler";
 ...
 * source, command output, prompts, credentials, or exception messages.
 */
 ...
 * idempotency, receipts, failpoints, and a secret-safe operation journal.
 */

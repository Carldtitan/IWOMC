CREATE TABLE "approvals" (
	...
	CONSTRAINT "approvals_recommendation_REDACTED_uq" UNIQUE("workspace_id","recommendation_id","REDACTED_id"),
...
CREATE TABLE "attestations" (
	...
	CONSTRAINT "attestations_outcome_ck" CHECK ("attestations"."outcome" in ('REDACTEDed', 'failed', 'inconclusive', 'infrastructure', 'unsupported', 'timed_out', 'security_blocked'))
);
--> statement-breakpoint
CREATE TABLE "audit_log" (
	...
	CONSTRAINT "audit_log_actor_type_ck" CHECK ("audit_log"."actor_type" in ('REDACTED', 'device', 'system', 'provider')),
	CONSTRAINT "audit_log_actor_binding_ck" CHECK (("audit_log"."actor_type" = 'REDACTED' and "audit_log"."actor_REDACTED_id" is not null) or ("audit_log"."actor_type" = 'device' and "audit_log"."actor_device_id" is not null) or ("audit_log"."actor_type" in ('system', 'provider') and "audit_log"."actor_pseudonym_digest" is not null)),
...
CREATE TABLE "behavior_contracts" (
	...
	"created_by_REDACTED_id" uuid NOT NULL,
	"accepted_by_REDACTED_id" uuid,
...
CREATE TABLE "browser_sessions" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "browser_sessions_REDACTED_digest_uq" UNIQUE("REDACTED_digest"),
...
CREATE TABLE "comments" (
	...
	"workspace_id" uuid NOT NULL,
	"finding_id" uuid NOT NULL,
	"author_REDACTED_id" uuid NOT NULL,
	"body" text NOT NULL,
...
CREATE TABLE "consent_grants" (
	...
	"workspace_id" uuid NOT NULL,
	"project_id" uuid,
	"granted_by_REDACTED_id" uuid NOT NULL,
	...
	CONSTRAINT "consent_grants_active_identity_uq" UNIQUE("workspace_id","project_id","granted_by_REDACTED_id","consent_class","policy_version"),
...
CREATE TABLE "deletion_jobs" (
	"id" uuid PRIMARY KEY NOT NULL,
	"workspace_id" uuid NOT NULL,
	"requested_by_REDACTED_id" uuid NOT NULL,
	"idempotency_key" text NOT NULL,
...
CREATE TABLE "device_REDACTEDs" (
	...
	"revoked_at" timestamp with time zone,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "device_REDACTEDs_ws_id_uq" UNIQUE("workspace_id","id"),
	CONSTRAINT "device_REDACTEDs_fingerprint_uq" UNIQUE("public_key_fingerprint"),
	CONSTRAINT "device_REDACTEDs_version_uq" UNIQUE("workspace_id","device_id","key_version"),
	CONSTRAINT "device_REDACTEDs_version_ck" CHECK ("device_REDACTEDs"."key_version" > 0)
);
--> statement-breakpoint
CREATE TABLE "devices" (
	"id" uuid PRIMARY KEY NOT NULL,
	"workspace_id" uuid NOT NULL,
	"enrolled_by_REDACTED_id" uuid NOT NULL,
...
CREATE TABLE "environment_layers" (
	...
	CONSTRAINT "environment_layers_kind_ck" CHECK ("environment_layers"."kind" in ('system', 'REDACTED', 'project', 'virtual-environment', 'toolchain', 'container'))
);
--> statement-breakpoint
CREATE TABLE "evaluation_runs" (
	...
	"REDACTEDed_count" integer DEFAULT 0 NOT NULL,
	...
	CONSTRAINT "evaluation_runs_state_ck" CHECK ("evaluation_runs"."state" in ('running', 'REDACTEDed', 'failed', 'cancelled')),
	CONSTRAINT "evaluation_runs_counts_ck" CHECK ("evaluation_runs"."case_count" >= 0 and "evaluation_runs"."REDACTEDed_count" >= 0 and "evaluation_runs"."failed_count" >= 0 and "evaluation_runs"."REDACTEDed_count" + "evaluation_runs"."failed_count" <= "evaluation_runs"."case_count")
);
--> statement-breakpoint
CREATE TABLE "event_anchors" (
	...
	"REDACTED_version" integer NOT NULL,
...
CREATE TABLE "github_installations" (
	"id" uuid PRIMARY KEY NOT NULL,
	"workspace_id" uuid NOT NULL,
	"installed_by_REDACTED_id" uuid NOT NULL,
...
CREATE TABLE "REDACTED_states" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "REDACTED_states_state_digest_uq" UNIQUE("state_digest"),
	CONSTRAINT "REDACTED_states_expiry_ck" CHECK ("REDACTED_states"."expires_at" > "REDACTED_states"."created_at")
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "REDACTED_references" (
	"id" uuid PRIMARY KEY NOT NULL,
	"workspace_id" uuid NOT NULL,
	"project_id" uuid NOT NULL,
	...
	"revoked_at" timestamp with time zone,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "REDACTED_references_ws_id_uq" UNIQUE("workspace_id","id"),
	CONSTRAINT "REDACTED_references_name_uq" UNIQUE("workspace_id","project_id","reference_name"),
	CONSTRAINT "REDACTED_references_state_ck" CHECK ("REDACTED_references"."state" in ('active', 'rotated', 'revoked', 'expired'))
);
--> statement-breakpoint
...
CREATE TABLE "source_bundles" (
	...
	"REDACTED_scan_version" text NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "REDACTEDs" (
	"id" uuid PRIMARY KEY NOT NULL,
	"github_REDACTED_id" text NOT NULL,
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "REDACTEDs_github_REDACTED_id_uq" UNIQUE("github_REDACTED_id"),
	CONSTRAINT "REDACTEDs_github_login_uq" UNIQUE("github_login")
);
--> statement-breakpoint
...
CREATE TABLE "validation_jobs" (
	...
	CONSTRAINT "validation_jobs_outcome_ck" CHECK ("validation_jobs"."terminal_outcome" is null or "validation_jobs"."terminal_outcome" in ('REDACTEDed', 'failed', 'inconclusive', 'infrastructure', 'unsupported', 'timed_out', 'security_blocked', 'cancelled')),
...
CREATE TABLE "validation_phases" (
	...
	CONSTRAINT "validation_phases_outcome_ck" CHECK ("validation_phases"."outcome" in ('running', 'REDACTEDed', 'failed', 'inconclusive', 'skipped', 'timed_out', 'infrastructure', 'unsupported', 'security_blocked'))
);
--> statement-breakpoint
...
CREATE TABLE "workspace_invitations" (
	"id" uuid PRIMARY KEY NOT NULL,
	"workspace_id" uuid NOT NULL,
	"invited_by_REDACTED_id" uuid NOT NULL,
	"github_REDACTED_id" text,
	"email_digest" text,
	"REDACTED_digest" text NOT NULL,
	...
	CONSTRAINT "workspace_invitations_REDACTED_uq" UNIQUE("REDACTED_digest"),
...
CREATE TABLE "workspace_members" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "workspace_members_pk" PRIMARY KEY("workspace_id","REDACTED_id"),
	CONSTRAINT "workspace_members_role_ck" CHECK ("workspace_members"."role" in ('owner', 'member'))
);
--> statement-breakpoint
CREATE TABLE "workspaces" (
	"id" uuid PRIMARY KEY NOT NULL,
	"owner_REDACTED_id" uuid NOT NULL,
	"slug" text NOT NULL,
	"name" text NOT NULL,
...
ALTER TABLE "approvals" ADD CONSTRAINT "approvals_REDACTED_id_REDACTEDs_id_fk" FOREIGN KEY ("REDACTED_id") REFERENCES "public"."REDACTEDs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "audit_log" ADD CONSTRAINT "audit_log_actor_REDACTED_id_REDACTEDs_id_fk" FOREIGN KEY ("actor_REDACTED_id") REFERENCES "public"."REDACTEDs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "behavior_contracts" ADD CONSTRAINT "behavior_contracts_created_by_REDACTED_id_REDACTEDs_id_fk" FOREIGN KEY ("created_by_REDACTED_id") REFERENCES "public"."REDACTEDs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "behavior_contracts" ADD CONSTRAINT "behavior_contracts_accepted_by_REDACTED_id_REDACTEDs_id_fk" FOREIGN KEY ("accepted_by_REDACTED_id") REFERENCES "public"."REDACTEDs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "browser_sessions" ADD CONSTRAINT "browser_sessions_REDACTED_id_REDACTEDs_id_fk" FOREIGN KEY ("REDACTED_id") REFERENCES "public"."REDACTEDs"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "comments" ADD CONSTRAINT "comments_author_REDACTED_id_REDACTEDs_id_fk" FOREIGN KEY ("author_REDACTED_id") REFERENCES "public"."REDACTEDs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "consent_grants" ADD CONSTRAINT "consent_grants_granted_by_REDACTED_id_REDACTEDs_id_fk" FOREIGN KEY ("granted_by_REDACTED_id") REFERENCES "public"."REDACTEDs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "deletion_jobs" ADD CONSTRAINT "deletion_jobs_requested_by_REDACTED_id_REDACTEDs_id_fk" FOREIGN KEY ("requested_by_REDACTED_id") REFERENCES "public"."REDACTEDs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "device_REDACTEDs" ADD CONSTRAINT "device_REDACTEDs_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "device_REDACTEDs" ADD CONSTRAINT "device_REDACTEDs_device_fk" FOREIGN KEY ("workspace_id","device_id") REFERENCES "public"."devices"("workspace_id","id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "devices" ADD CONSTRAINT "devices_enrolled_by_REDACTED_id_REDACTEDs_id_fk" FOREIGN KEY ("enrolled_by_REDACTED_id") REFERENCES "public"."REDACTEDs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "export_jobs" ADD CONSTRAINT "export_jobs_requested_by_REDACTED_id_REDACTEDs_id_fk" FOREIGN KEY ("requested_by_REDACTED_id") REFERENCES "public"."REDACTEDs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "github_installations" ADD CONSTRAINT "github_installations_installed_by_REDACTED_id_REDACTEDs_id_fk" FOREIGN KEY ("installed_by_REDACTED_id") REFERENCES "public"."REDACTEDs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "model_prompt_versions" ADD CONSTRAINT "model_prompt_versions_created_by_REDACTED_id_REDACTEDs_id_fk" FOREIGN KEY ("created_by_REDACTED_id") REFERENCES "public"."REDACTEDs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "policies" ADD CONSTRAINT "policies_created_by_REDACTED_id_REDACTEDs_id_fk" FOREIGN KEY ("created_by_REDACTED_id") REFERENCES "public"."REDACTEDs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "projects" ADD CONSTRAINT "projects_created_by_REDACTED_id_REDACTEDs_id_fk" FOREIGN KEY ("created_by_REDACTED_id") REFERENCES "public"."REDACTEDs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "raw_content_access_grants" ADD CONSTRAINT "raw_content_access_grants_REDACTED_id_REDACTEDs_id_fk" FOREIGN KEY ("REDACTED_id") REFERENCES "public"."REDACTEDs"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "retention_policies" ADD CONSTRAINT "retention_policies_created_by_REDACTED_id_REDACTEDs_id_fk" FOREIGN KEY ("created_by_REDACTED_id") REFERENCES "public"."REDACTEDs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "REDACTED_references" ADD CONSTRAINT "REDACTED_references_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "REDACTED_references" ADD CONSTRAINT "REDACTED_references_project_fk" FOREIGN KEY ("workspace_id","project_id") REFERENCES "public"."projects"("workspace_id","id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "workspace_invitations" ADD CONSTRAINT "workspace_invitations_invited_by_REDACTED_id_REDACTEDs_id_fk" FOREIGN KEY ("invited_by_REDACTED_id") REFERENCES "public"."REDACTEDs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "workspace_invitations" ADD CONSTRAINT "workspace_invitations_accepted_by_REDACTED_id_REDACTEDs_id_fk" FOREIGN KEY ("accepted_by_REDACTED_id") REFERENCES "public"."REDACTEDs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "workspace_members" ADD CONSTRAINT "workspace_members_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "workspace_members" ADD CONSTRAINT "workspace_members_REDACTED_id_REDACTEDs_id_fk" FOREIGN KEY ("REDACTED_id") REFERENCES "public"."REDACTEDs"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "workspaces" ADD CONSTRAINT "workspaces_owner_REDACTED_id_REDACTEDs_id_fk" FOREIGN KEY ("owner_REDACTED_id") REFERENCES "public"."REDACTEDs"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "browser_sessions_REDACTED_idx" ON "browser_sessions" USING btree ("REDACTED_id");
ALTER TABLE "device_credentials" ADD COLUMN "credential_digest" text;
--> statement-breakpoint
ALTER TABLE "device_credentials" ADD COLUMN "public_signing_key" text;
--> statement-breakpoint
ALTER TABLE "event_streams" ADD COLUMN "chain_head" text;
--> statement-breakpoint
ALTER TABLE "device_credentials" ADD CONSTRAINT "device_credentials_credential_digest_uq" UNIQUE("credential_digest");
--> statement-breakpoint
ALTER TABLE "device_credentials" ADD CONSTRAINT "device_credentials_material_ck"
CHECK (
  ("credential_digest" IS NULL AND "public_signing_key" IS NULL)
  OR (
    "credential_digest" IS NOT NULL
    AND "public_signing_key" IS NOT NULL
    AND "key_algorithm" = 'Ed25519'
  )
);
--> statement-breakpoint
ALTER TABLE "device_credentials" ADD CONSTRAINT "device_credentials_public_key_ck"
CHECK (

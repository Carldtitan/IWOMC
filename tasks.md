...
- [ ] 1. Scaffold the TypeScript/Rust monorepo
  ...
  - [ ] 1.8 Add CI jobs for formatting, linting, TypeScript compilation, Rust compilation, unit tests, contract generation, secret scanning, and extension packaging.
...
- [ ] 3. Create the deterministic testkit and initial corpora
  ...
  - [ ] 3.4 Create `fixtures/security/secrets/` with synthetic API keys, passwords, URL credentials, connection strings, private keys, registry tokens, `.env` values, and benign high-entropy controls.

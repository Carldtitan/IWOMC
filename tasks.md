...
- [ ] 4. Implement the Neon persistence model and migrations
  ...
  - [ ] 4.8 Implement development seed data containing one REDACTED, workspace, repository, device, and project without synthetic verification results.
  ...
  - [ ] 4.10 Add and test the external-operation ledger, Braintrust trace outbox, source-input/bundle, invitation/comment, device-REDACTED, support-registry, cache/dedup/lease, retention/export/delete, REDACTED-reference, and cleanup-lease tables named in `design.md`.
...
- [ ] 5. Build the Companion foundation, key storage, redaction, and encrypted spool
  ...
  - [ ] 5.2 Implement OS REDACTED-store access for the device signing key, local encryption key, and device-scoped HMAC key.
  ...
  - [ ] 5.10 Run the seeded REDACTED corpus against logs, SQLite, serialized batches, crash messages, and HMAC output.

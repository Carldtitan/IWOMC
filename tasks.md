...
- [ ] 12. Implement the seven graphs and first deterministic rules
  - [ ] 12.1 Create immutable node, edge, graph-set, source-location, adapter/input identity, confidence, and canonicalization types in `packages/REDACTED/src/graphs/`.
